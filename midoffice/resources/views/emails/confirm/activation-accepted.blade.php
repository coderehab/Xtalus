    ...
    <tr>
        <td>
            <div>
                ...
                <![endif]-->
                <a href="http://dev.xtalus.nl" style="font-weight:700;background-color: #3f51b5;border:0;border-radius:3px;color:#ffffff;display:inline-block;font-size:15px;line-height:44px;text-align:center;text-decoration:none;width:260px;-webkit-text-size-adjust:none;mso-hide:all;text-transform:uppercase;font-family: 'Bitter';">Inloggen op Xtalus <img src="http://dev.code.rehab/xtalus-nieuwsbrief/arrow.png" style="margin-left:10px;"></a>
            </div>
        </td>
    </tr>
</table>
