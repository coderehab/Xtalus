...
<h2 style="margin:20px 0; font-weight:bold; color: #263238; font-family: 'Montserrat'; font-size:24px;">Hé admin,</h2>
    ...
    <tr>
        <td>
            <div>
                ...
                <![endif]-->
                <a href="http://test.xtalus.gedge.nl/simple/wicket" style="font-weight:700;background-color: #3f51b5;border:0;border-radius:3px;color:#ffffff;display:inline-block;font-size:15px;line-height:44px;text-align:center;text-decoration:none;width:320px;-webkit-text-size-adjust:none;mso-hide:all;text-transform:uppercase;font-family: 'Montserrat';">Verifieer nieuwe gebruiker <img src="http://dev.code.rehab/xtalus-nieuwsbrief/arrow.png" style="margin-left:10px;"></a>
            </div>
        </td>
    </tr>
</table>
