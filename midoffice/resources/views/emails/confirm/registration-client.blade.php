...
<h2 style="margin:20px 0; font-weight:bold; color: #263238; font-family: 'Bitter'; font-size:24px;">Welkom {{ucfirst($postdata->firstname)}},</h2>
...
<table style="margin:0;">
  <tr align="left">
    ...
    <td style="font-family: 'Bitter'; font-size:15px;">{{$postdata->email}}</td>
  </tr>
  <tr>
    <td style="font-family: 'Bitter'; font-size:15px;">Wachtwoord:</td>
    <td style="font-family: 'Bitter'; font-size:15px;">*Het door u opgegeven wachtwoord*</td>
  </tr>
</table>
</p>
