...
<h2 style="margin:20px 0; font-weight:normal; color:#212121;">
  Welkom {{ucfirst($postdata->firstname)}},
</h2>
<p style="color:#888; line-height:180%; font-weight:300;">
Bedankt voor uw registratie! Uw account is aangevraagd en wordt momenteel door een van onze medewerkers geverifieerd. Hiermee kunnen we de kwaliteit op Xtalus garanderen.<br><br>

Binnen enkele werkdagen is uw account geverifieerd en kunt u inloggen met de volgende gegevens:<br><br>

Gebruikersnaam: {{$postdata->username}}<br>
Wachtwoord:     {{$postdata->password}}<br><br>
