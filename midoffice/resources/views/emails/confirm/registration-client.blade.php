...
<table style="margin:0;">
	<tr align="left">
		...
		<td><a style="color: #263238; text-decoration:none; border-bottom: 2px solid #b0bec5;" href="mailto:{{$postdata->email}}">{{$postdata->email}}</a></td>
	</tr>
	<tr>
		<td>Wachtwoord:</td>
		<td>{{$postdata->password}}</td>
	</tr>
</table>
</p>
    ...
    <tr>
        <td>
            <div>
                ...
                <w:anchorlock/>
								<center style="color:#ffffff;font-family:Helvetica, Arial,sans-serif;font-size:16px;">MEER WETEN? BEZOEK ONZE WEBSITE <img src="http://dev.code.rehab/xtalus-nieuwsbrief/arrow.png" width="5" height="10" style="margin:20px 0 0 10px; float:right;"></center>
                </v:roundrect>
                <![endif]-->
