...
export default DS.Model.extend({
	companies: DS.attr({defaultValue:[]}),
	...
	pictureBackground: DS.attr({defaultValue:'http://www.deschaatssport.nl/uploads/content/387002_299835413370911_100000333633586_1036324_935047398_n.jpg'}),
	...
	entityStudent: function(){
		return this.get('entity') == "Student";
	}.property('entity'),
